...
export default function ArticlePage() {
  ...
  useEffect(() => {
    ...
    const pageUrl = 'https://smokeleathertotes-69r4r.com/articles/' + article.slug;
    const catUrl = 'https://smokeleathertotes-69r4r.com/' + article.categorySlug;
    ...
    articleScript.textContent = JSON.stringify({
      ...
      "publisher": { "@type": "Organization", "name": 'Smoke Leather Totes', "url": 'https://smokeleathertotes-69r4r.com' },
      "url": pageUrl,
    });
    ...
    breadcrumbScript.textContent = JSON.stringify({
      ...
      "@type": "BreadcrumbList",
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "name": "Home", "item": 'https://smokeleathertotes-69r4r.com' },
