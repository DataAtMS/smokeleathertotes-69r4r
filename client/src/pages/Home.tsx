...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setMeta('meta[property="og:url"]', 'og:url', 'https://smokeleathertotes-69r4r.com/', 'property');
    ...
    if (canonical) {
      canonical.setAttribute('href', 'https://smokeleathertotes-69r4r.com/');
    }
    ...
    if (!existingScript) {
      ...
      script.textContent = JSON.stringify({
        ...
        "url": 'https://smokeleathertotes-69r4r.com',
        "description": desc,
      });
        ...
        <div style={{ borderTop: `1px solid ${COLOR.border}`, paddingTop: "20px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "8px" }}>
            <p style={{ fontFamily: "'Space Mono', monospace", fontSize: "10px", color: COLOR.faint }}>
              © {new Date().getFullYear()} SMOKELEATHERTOTES-69R4R.COM
            </p>
            <p style={{ fontFamily: "'Space Mono', monospace", fontSize: "10px", color: COLOR.faint }}>
